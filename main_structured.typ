...
#let profile_section = [
  #let entries = for (key, value) in data.summary.profile{
    ([*#key:*], value,)
  }
  #grid(
    columns: 2,
...
#let experience_section = [
  #for entry in data.experience [
    #grid(
      ...
      text("@", size: eval(settings.font.size.description) - 1pt) + link(entry.company.website)[#entry.company.name],
